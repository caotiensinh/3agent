...
class WorkflowDraftGatewayContractTests(unittest.TestCase):
    def test_v20_is_additive_on_hardened_v19_boundary(self) -> None:
        self.assertTrue(issubclass(chat_gateway_v20.WorkflowDraftApplication, SecurityMonitoringConfigApplication))
        self.assertTrue(issubclass(chat_gateway_v20.WorkflowDraftHTTPHandler, SecurityMonitoringConfigHTTPHandler))
