...
from three_agent.chat_gateway_v5 import _history_owner_key
from three_agent.chat_gateway_v15 import ContextAwareProjectChatService
...
class ContextAwareGatewayTests(unittest.TestCase):
    ...
    def test_vietnamese_short_follow_up_uses_prior_context_and_keeps_vietnamese(self) -> None:
        ...
        self.assertLess(prompt.index("<CURRENT_USER_REQUEST>"), prompt.index("<RECENT_CONVERSATION_CONTEXT>"))
        plan = service.context_plan_for_job(job.job_id)
