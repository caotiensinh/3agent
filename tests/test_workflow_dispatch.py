...
class FakeRunResult:
    ...
    research_artifacts: list[str] | None = None
    presentation_artifacts: list[str] | None = None
    daily_report_artifacts: list[str] | None = None
    error: str | None = None
    manifest_path: str = "/srv/workspace/private/workflow.json"
...
class FakeWorkflow:
    ...
    def run_task(self, task_id, **kwargs):
        ...
        return FakeRunResult(
            task_id,
            research_artifacts=["/srv/workspace/private/research.json"],
            presentation_artifacts=["/srv/workspace/private/deck.pptx"],
            daily_report_artifacts=["/srv/workspace/private/daily.json"],
        )
...
class WorkflowDispatchTests(unittest.TestCase):
    ...
    def test_exact_authorization_runs_once_rejects_replay_and_hides_server_paths(self):
        prepared = self.controller.prepare(executable_contract())
