...
_JA_FOLLOW_UP_PATTERNS = (
    ...
    # A numbered item is a cross-turn reference only when it starts the request.
    # Standalone prompts often enumerate 1つ目/2つ目/3つ目 internally.
    r"^(?:では|じゃあ|それでは|その)?\s*(?:2つ目|２つ目|二つ目|第二)(?:だけ|の|を|は|について|[?？。！!\s]|$)",
