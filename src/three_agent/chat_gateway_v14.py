...
class WorkflowV3Application(WorkflowDispatchApplication):
    def __init__(
        ...
        # V3 changes condition vocabulary only; Workflow Studio still has no
        # authority to grant execution by itself.
...
class WorkflowV3HTTPHandler(WorkflowDispatchHTTPHandler):
    """Prompt-aware Workflow Studio with durable V3 checkpoint execution."""
