...
- `SECURITY_MONITORING_V004_INCIDENT_TRIAGE.md` — bounded deterministic incident triage, confidence scoring, escalation rules, and evidence-preserving response recommendations.
- `SECURITY_MONITORING_V004_ALERT_AGENT.md` — bounded local alert intake and deterministic triage agent with no autonomous remediation authority.
