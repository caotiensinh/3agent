...
- `NETWORK_SECURITY_INTELLIGENCE_V004.md` — ephemeral DNS behavior feature extraction, immutable metadata-only DNS features, target-scoped rare-entity baselines, per-initiator risk isolation, bounded store-backed behavior analysis, and deterministic corroborated advisory risk scoring.
